import { type IApiResponse, type ICreateUsersRequest, type IUser } from "../types"
...
class ApiClient {
    ...
    async createUsers(data: ICreateUsersRequest):
        Promise<IApiResponse<IUser>> {
        return this.post<ICreateUsersRequest, IApiResponse<IUser>>(`/users`, data)
    }
}
